import styled from "../styles/Stats.module.css";

const Stats = () => {
  return (
    <div className={styled.mainDiv}>
      <h2>Advanced Statistics</h2>
      <p className={styled.discription}>
        Track how your links are performing across the web with our advanced
        satiscts dashbaord.
      </p>

      <div className={styled.blockDiv}>
        <div className={styled.flexDiv}>
          <hr />
          <div className={styled.heightZero}>
            <div className={styled.statDiv}>
          ...
          <div className={styled.heightOne}>
            <div className={styled.statDiv}>
              <div className={styled.logoDiv}>
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40">
                  <path
              ...
              <div className={styled.infoDiv}>
                ...
                <p>
                  Boost your brand Recognization with each click. Generic links
          ...
          <div className={styled.heightTwo}>
            <div className={styled.statDiv}>
              <div className={styled.logoDiv}>
              ...
              <div className={styled.infoDiv}>
                ...
                <p>
                  Inprove brand awareness and content discoverabilty through
                  customizable links, super charging audiance engagement.
                </p>
              </div>
            </div>
          </div>
